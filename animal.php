    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <div class="list-group">
                ...
                <a href="animal.php" class="list-group-item active">Animal Licking Salt</a>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <a href="#"><img class="card-img-top" src="img/AnimalSaltLicking/6.jpg" alt=""></a>
                <!--<div class="card-body">
                    <h4 class="card-title">
                        <a href="#">Item Five</a>
                    </h4>
                ...
                <div class="card-footer">
                    <small class="text-muted">Natural Shape</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <a href="#"><img class="card-img-top" src="img/AnimalSaltLicking/9.jpg" alt=""></a>
                <!--<div class="card-body">
                    <h4 class="card-title">
                        <a href="#">Item Six</a>
                    </h4>
                ...
                <div class="card-footer">
                    <small class="text-muted">Cylinder Shape</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <a href="#"><img class="card-img-top" src="img/AnimalSaltLicking/11.jpg" alt=""></a>
                <!--<div class="card-body">
                    <h4 class="card-title">
                        <a href="#">Item Six</a>
                    </h4>
                ...
                <div class="card-footer">
                    <small class="text-muted">Block Shape</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <a href="#"><img class="card-img-top" src="img/AnimalSaltLicking/12.jpg" alt=""></a>
                <!--<div class="card-body">
                    <h4 class="card-title">
                        <a href="#">Item Six</a>
                    </h4>
                ...
                <div class="card-footer">
                    <small class="text-muted">Tile Shape</small>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="animal-pic">
                <h1>Animal Licking Salt</h1>
                <div class="row">

                    <div class="col-lg-4">
                        <img src="img/AnimalSaltLicking/1.jpg">
                    </div>
                    <div class="col-lg-4">
                        <img src="img/AnimalSaltLicking/2.jpg">
                    </div>
                    <div class="col-lg-4">
                        <img src="img/AnimalSaltLicking/4.jpg">
                    </div>
                </div><br>
                <div class="row">
                    <div class="col-lg-4">
                        <img src="img/AnimalSaltLicking/5.jpg">
                    </div>
                    <div class="col-lg-4">
                        <img src="img/AnimalSaltLicking/8.jpg">
                    </div>
                    <div class="col-lg-4">
                        <img src="img/AnimalSaltLicking/10.jpg">
                    </div>
                </div>
            </div>
        </div>
