    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <div class="list-group">
                ...
                <a href="bath.php" class="list-group-item active">Bath Salts </a>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <a href="#"><img class="card-img-top" src="img/BathSalt/2.jpg" alt=""></a>
                <!--<div class="card-body">
                    <h4 class="card-title">
                        <a href="#">Item Six</a>
                    </h4>
                ...
                <div class="card-footer">
                    <small class="text-muted">Black Salt Chunks</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <a href="#"><img class="card-img-top" src="img/BathSalt/4.jpg" alt=""></a>
                <!--<div class="card-body">
                    <h4 class="card-title">
                        <a href="#">Item Six</a>
                    </h4>
                ...
                <div class="card-footer">
                    <small class="text-muted">Small Salt Grains</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <a href="#"><img class="card-img-top" src="img/BathSalt/6.jpg" alt=""></a>
                <!--<div class="card-body">
                    <h4 class="card-title">
                        <a href="#">Item Six</a>
                    </h4>
                ...
                <div class="card-footer">
                    <small class="text-muted">Dark Salt Grains</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <a href="#"><img class="card-img-top" src="img/BathSalt/7.jpg" alt=""></a>
                <!--<div class="card-body">
                    <h4 class="card-title">
                        <a href="#">Item Six</a>
                    </h4>
                ...
                <div class="card-footer">
                    <small class="text-muted">Pink Salt Chunks</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <a href="#"><img class="card-img-top" src="img/SpaSaltProducts/12.jpeg" alt=""></a>
                <!--<div class="card-body">
                    <h4 class="card-title">
                        <a href="#">Item Six</a>
                    </h4>
                ...
                <div class="card-footer">
                    <small class="text-muted">Bath Salt Stones</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
                <a href="#"><img class="card-img-top" src="img/SpaSaltProducts/13.jpeg" alt=""></a>
                <!--<div class="card-body">
                    <h4 class="card-title">
                        <a href="#">Item Six</a>
                    </h4>
                ...
                <div class="card-footer">
                    <small class="text-muted">Bath Salt Soaps</small>
                </div>
            </div>
        </div>
