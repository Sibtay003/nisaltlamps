...
<footer class="py-5 bg-dark">
        ...
        <div class="row text-center">
            <div class="col-lg-12 col-lg-offset-3">
                <ul class="menu">
                    ...
                    <li>
                        <a href="factory.php">Factory Tour</a>
                    </li>

                    <li>
                        <a href="N&I%20CATALOG%20(2).pdf" target="_blank">Catalog</a>
                    </li>
                    <li>
    ...
    <div class="container">
        <div class="copyright">
            <p class="m-0 text-center text-white">Copyright &copy; 2017 N&I Salt International<b>( This Website is still under the Process of updation.So, We really apologise for any inconvenience)</b></p>
            <p>  </p>
        </div>
    </div>
</footer>
